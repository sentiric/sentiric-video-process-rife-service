...
RUN uv pip install --no-cache torch==2.5.1 torchvision --index-url https://download.pytorch.org/whl/cu124
...
EXPOSE 16150 16151
CMD ["sh", "-c", "uvicorn app.main:app --host 0.0.0.0 --port 16150 --no-access-log"]